...
- Outcome Loop **никогда не ретроспективно изменяет прошлые рекомендации**
- Labels используются **исключительно как training signal** для будущих моделей
- Rules остаются frozen
- ML учится только ранжировать лучше

**Для:**
- ✅ Аудита (прошлое неизменно)
- ✅ Доверия пользователей (честность)
- ✅ Юридической чистоты (compliance)
